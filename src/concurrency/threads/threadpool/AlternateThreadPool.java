 ...
 * @author Atul Sharma
 */
public class AlternateThreadPool {
     ...
     */
    private AlternateThreadPool(int threadCount) {
     ...
     */
    public static AlternateThreadPool getInstance() {
     ...
     * @return new SimpleThreadpool
     */
    public static AlternateThreadPool getInstance(int threadCount) {
        return new AlternateThreadPool(threadCount);
    }
